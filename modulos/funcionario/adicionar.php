        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="cadastroFuncionarios.html" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Cadastro de Funcionários</h1>
          </div><!-- /.col -->
    ...
    <div class="container">
              ...
              <form role="form" action="#" method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>RG</label>
                    <input type="text" min="6" max="11" class="form-control" name="RG" id="RG" placeholder="Insira o Nº do RG">
                  </div>
                  <div class="form-group">
                    <label>Email</label>
